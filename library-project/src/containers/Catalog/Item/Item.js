...
const Item = () => {
    ...
    if (record && typeof record !== "string") {
      ...
      if (record.opened) {
        ...
        setPreviewData({
          ...
          collateral_price: record.collateral_price,
        });
      }
    } else {
      alert(
  ...
  const text = "Here you can create an order for renting this book";
  return (
    <Wrapper>
      <InfoWrapper>
        <ItemImage
        ...
        <Description>
          <DescriptionFirst>
            <BookName>
              {name} <br /> Collateral price: {book.original_collateral_price}{" "}
              <br /> Price for week rent: {book.original_weekly_rent_price}
            </BookName>
        ...
        {preview && recordInfo ? (
          ...
          >
            <BookName>
              {" "}
              Preview order information(including discounts):
            </BookName>
            <SecurityText>
              Rent price for {weeksNumber} weeks for this book:{" "}
              {previewData.rentPrice}
            </SecurityText>
            <SecurityText>
              Collateral price for this book: {previewData.collateral_price}
            </SecurityText>
          </Description>
        ) : (
          <></>
